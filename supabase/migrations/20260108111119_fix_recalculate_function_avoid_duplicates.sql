/*
  # Fix Recalculate Function to Avoid Duplicates

  1. Changes
    - Check for existing standings before each insert to avoid duplicate key errors
    - Handle case where players appear in both teams and individual players tables
*/
